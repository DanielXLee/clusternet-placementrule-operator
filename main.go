...
import (
	...
	clusternetapi "github.com/clusternet/clusternet/pkg/apis/clusters/v1beta1"
	...
	"github.com/DanielXLee/clusternet-placementrule-operator/controllers"
...
func init() {
	...
	utilruntime.Must(clusternetapi.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fb693320.open-cluster-management.io",
	})
	if err != nil {
