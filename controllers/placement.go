...
// func (r *PlacementRuleReconciler) filteClustersByStatus(instance *appsv1alpha1.PlacementRule, clmap map[string]*spokeClusterV1.ManagedCluster) error {
...
func (r *PlacementRuleReconciler) sortClustersByResourceHint(instance *appsv1alpha1.PlacementRule,
	...
	if instance.Spec.ResourceHint.Order == appsv1alpha1.SelectionOrderAsce {
	...
	for _, cl := range clmap {
		...
		// 	case appsv1alpha1.ResourceTypeCPU:
		// 		newcli.Metrics = cl.Status.Allocatable[spokeClusterV1.ResourceCPU]
		// 	case appsv1alpha1.ResourceTypeMemory:
...
func (r *PlacementRuleReconciler) pickClustersByReplicas(instance *appsv1alpha1.PlacementRule,
	clmap map[string]*spokeClusterV1.ManagedCluster, clidx *clusterIndex) []appsv1alpha1.PlacementDecision {
	newpd := []appsv1alpha1.PlacementDecision{}
	total := len(clmap)
	...
	if clidx == nil {
		for _, cli := range instance.Status.Decisions {
			...
			if picked < total {
				pd := appsv1alpha1.PlacementDecision{
...
func (r *PlacementRuleReconciler) filteClustersByPolicies(instance *appsv1alpha1.PlacementRule,
...
func (r *PlacementRuleReconciler) filteClustersByUser(instance *appsv1alpha1.PlacementRule,
	...
	if _, ok := annotations[appsv1alpha1.UserIdentityAnnotation]; !ok {
		return nil
	}
...
func (r *PlacementRuleReconciler) filteClustersByIdentityAnno(instance *appsv1alpha1.PlacementRule, clmap map[string]*spokeClusterV1.ManagedCluster) error {
	objanno := instance.GetAnnotations()
	if objanno == nil {
		return nil
	}

	if _, ok := objanno[appsv1alpha1.UserIdentityAnnotation]; !ok {
		return nil
	}
...
func (r *PlacementRuleReconciler) checkUserPermission(annotations map[string]string, managedCluster *spokeClusterV1.ManagedCluster) bool {
	user, groups := utils.ExtractUserAndGroup(annotations)
